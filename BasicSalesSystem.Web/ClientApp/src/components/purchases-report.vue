...
<script lang="ts">
    ...
    import { Red20 } from 'chartjs-plugin-colorschemes/src/colorschemes/colorschemes.tableau';
    ...
    export default class PurchasesReportComponent extends Vue {
        ...
        private async loadStatistics() {
            var self = this;
            try {
                var response = await self.purchaseService.getAnnualStatistics();
